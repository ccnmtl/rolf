...
import os.path
admin.autodiscover()
from rolf.rolf_main.models import Category, Application, Deployment, Push, Recipe, Stage
...
urlpatterns = patterns('',
                       ...
                       (r'^category/(?P<object_id>\d+)/$','rolf.rolf_main.views.generic_detail',category_info_dict),
                       (r'^category/(?P<object_id>\d+)/add_application/$','rolf.rolf_main.views.add_application'),
                       ...
                       (r'^application/(?P<object_id>\d+)/$','rolf.rolf_main.views.generic_detail',application_info_dict),
                       (r'^application/(?P<object_id>\d+)/add_deployment/$','rolf.rolf_main.views.add_deployment'),
                       ...
                       (r'^deployment/(?P<object_id>\d+)/$','rolf.rolf_main.views.generic_detail',deployment_info_dict),
                       (r'^deployment/(?P<object_id>\d+)/add_setting/$','rolf.rolf_main.views.add_setting'),
                       (r'^deployment/(?P<object_id>\d+)/edit_settings/$','rolf.rolf_main.views.edit_settings'),
                       (r'^deployment/(?P<object_id>\d+)/add_stage/$','rolf.rolf_main.views.add_stage'),
                       (r'^deployment/(?P<object_id>\d+)/clone/$','rolf.rolf_main.views.clone_deployment'),
                       (r'^deployment/(?P<object_id>\d+)/push/$','rolf.rolf_main.views.push'),
                       (r'^deployment/(?P<object_id>\d+)/remove_permission/$','rolf.rolf_main.views.remove_permission'),
                       (r'^deployment/(?P<object_id>\d+)/add_permission/$','rolf.rolf_main.views.add_permission'),

                       (r'^deployment/(?P<object_id>\d+)/remove_flag/$','rolf.rolf_main.views.remove_flag'),
                       (r'^deployment/(?P<object_id>\d+)/add_flag/$','rolf.rolf_main.views.add_flag'),

                       (r'^deployment/(?P<object_id>\d+)/rollback/$','rolf.rolf_main.views.rollback'),
                       (r'^deployment/(?P<object_id>\d+)/reorder_stages/$','rolf.rolf_main.views.reorder_stages'),
                       ...
                       (r'^push/(?P<object_id>\d+)/$','rolf.rolf_main.views.generic_detail',push_info_dict),
                       ...
                       (r'^cookbook/(?P<object_id>\d+)/$','rolf.rolf_main.views.generic_detail',recipe_info_dict),
                       (r'^cookbook/(?P<object_id>\d+)/edit/$','rolf.rolf_main.views.edit_recipe'),
                       ...
                       (r'^stage/(?P<object_id>\d+)/$','rolf.rolf_main.views.generic_detail',stage_info_dict),
