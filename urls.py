...
urlpatterns = patterns('',
                       ...
                       (r'category/(?P<object_id>\d+)/$','rolf_main.views.category_detail'),
                       ...
                       (r'application/(?P<object_id>\d+)/$','rolf_main.views.application_detail'),
                       ...
                       (r'deployment/(?P<object_id>\d+)/$','rolf_main.views.deployment_detail'),
                       ...
                       (r'push/(?P<object_id>\d+)/$','rolf_main.views.push_detail'),
                       ...
                       (r'cookbook/(?P<object_id>\d+)/$','rolf_main.views.recipe_detail'),
                       ...
                       (r'stage/(?P<object_id>\d+)/$','rolf_main.views.stage_detail'),
